...
namespace DigitalRuby.WeatherMaker
{
    ...
    public static class WeatherMakerEditorCommands
    {
        ...
        [MenuItem("Window/Weather Maker/Add Weather Maker to Scene", priority = 0)]
        ...
        [MenuItem("Window/Weather Maker/Generate Normal Texture (2D)", priority = 10)]
        ...
        [MenuItem("Window/Weather Maker/Generate 3D Texture", priority = 20)]
        ...
        [MenuItem("Window/Weather Maker/Combine Normal and Alpha Textures", priority = 30)]
