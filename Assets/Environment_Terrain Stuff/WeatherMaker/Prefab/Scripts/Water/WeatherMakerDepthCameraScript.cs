    ...
    public class WeatherMakerDepthCameraScript : MonoBehaviour
    {
        ...
        private void Update()
        {
            if (Renderer != null)
            {
                ...
                Renderer.sharedMaterial.SetTexture("_WeatherMakerYDepthTexture", DepthTexture);
            }
        }
        ...
        private void OnEnable()
        {
            ...
            string cameraObjectName = name + "_YDepthBufferCamera";
        ...
        private void UpdateResources()
        {
            if (DepthTexture == null || DepthTexture.width != RenderTextureSize)
            {
                ...
                DepthTexture = new RenderTexture(size, size, 16, RenderTextureFormat.Depth);
        ...
        {
            if (depthCamera == null || Renderer.sharedMaterial == null)
            {
                return;
            }
            ...
            Renderer.sharedMaterial.SetVector("_WeatherMakerYDepthParams", new Vector4(CameraDepth, heightPercent, depthPercent, 1.0f / depthPercent));
            Dirty = false;
        }
    }
}
