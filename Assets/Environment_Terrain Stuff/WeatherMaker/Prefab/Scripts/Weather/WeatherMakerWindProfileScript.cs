...
namespace DigitalRuby.WeatherMaker
{
    ...
    {
        [SingleLine("The range of wind speed intensities. The wind zone wind main is set to WindIntensity * MaximumWindSpeed * WindMainMultiplier.")]
        ...
        [SingleLine("Random percent of total transition duration that is spent changing the wind rotation. Lower values rotate the wind faster.")]
        ...
        [SingleLine("How fast the wind changes once a change is begun. Set to 0 for instant change.")]
