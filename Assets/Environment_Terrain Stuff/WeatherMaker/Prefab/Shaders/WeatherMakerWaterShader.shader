...
Shader "WeatherMaker/WeatherMakerWaterShader"
{
	Properties
	{
		...
		_Shininess("Surface shininess", Range(2.0, 500.0)) = 200.0
	...
	Subshader
	{
		...
		Pass
		{
			...
			#pragma multi_compile __ WATER_REFLECTIVE WATER_UNDERWATER
			#pragma multi_compile __ WATER_LIGHT_FORWARD_BASE
		...
		Pass
		{
			...
			#define WATER_LIGHT_FORWARD_BASE
