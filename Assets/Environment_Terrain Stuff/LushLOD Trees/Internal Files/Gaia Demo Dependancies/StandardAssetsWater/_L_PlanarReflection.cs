...
namespace LushLODTreeGaiaDemo.UnityStandardAssets.Water
{
    ...
    public class _L_PlanarReflection : MonoBehaviour
    {
        public LayerMask reflectionMask;
        public bool reflectSkybox = false;
        public Color clearColor = Color.grey;
        public String reflectionSampler = "_LushLODGaiaDemoReflectionTex";
        ...
        public void Start()
        {
            m_SharedMaterial = ((_L_WaterBase)gameObject.GetComponent(typeof(_L_WaterBase))).sharedMaterial;
        }
