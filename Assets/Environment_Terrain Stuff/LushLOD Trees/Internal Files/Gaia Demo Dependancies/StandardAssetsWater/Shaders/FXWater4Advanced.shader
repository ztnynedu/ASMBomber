...
Shader "Hidden/LushLODTree/Water4" {
Properties {
	_LushLODGaiaDemoReflectionTex ("Internal reflection", 2D) = "white" {}
...
CGINCLUDE
	...
	#include "LushLODWaterInclude.cginc"
	...
	// textures
	sampler2D _BumpMap;
	sampler2D _LushLODGaiaDemoReflectionTex;
	...
	half4 frag( v2f i ) : SV_Target
	{
		...
		half4 rtRefractions = tex2Dproj(_RefractionTex, UNITY_PROJ_COORD(grabWithOffset));
			...
			half4 rtReflections = tex2Dproj(_LushLODGaiaDemoReflectionTex, UNITY_PROJ_COORD(screenWithOffset));
		#endif
