...
namespace DigitalRuby.WeatherMaker
{
    ...
    public class WeatherMakerCloudProfileScript : ScriptableObject
    {
        ...
        [Tooltip("How much clouds affect directional light shadow strength, lower values ensure no reduction.")]
        [Range(0.0f, 3.0f)]
        public float CloudShadowStrength = 1.0f;

        [Tooltip("How much clouds affect directional light intensity, lower values ensure no reduction.")]
        [Range(0.0f, 3.0f)]
        ...
        public void SetShaderCloudParameters(Material m)
        {
            ...
            if (CloudsEnabled)
            {
                ...
                WeatherMakerShaderIds.SetVectorArray(m, "_CloudNoiseVelocity", cloudNoiseVelocityAccum1, cloudNoiseVelocityAccum2, cloudNoiseVelocityAccum3, cloudNoiseVelocityAccum4);
                ...
                else
                {
                    ...
                    WeatherMakerShaderIds.SetVectorArray(m, "_CloudNoiseMaskVelocity", cloudNoiseMaskVelocityAccum1, cloudNoiseMaskVelocityAccum2, cloudNoiseMaskVelocityAccum3, cloudNoiseMaskVelocityAccum4);
                ...
                float shadowDotPower = Mathf.Clamp(Mathf.Pow(3.0f * Vector3.Dot(Vector3.down, WeatherMakerLightManagerScript.Instance.Sun.transform.forward), 0.5f), 0.0f, 1.0f);
                ...
                if (Application.isPlaying && WeatherMakerLightManagerScript.Instance != null)
                {
                    ...
                    float sunIntensityMultiplier = Mathf.Clamp(1.0f - (CloudDensityTotal * CloudLightStrength), 0.0f, 1.0f);
            ...
            else if (Application.isPlaying && WeatherMakerLightManagerScript.Instance != null)
            {
                WeatherMakerLightManagerScript.Instance.DirectionalLightIntensityMultipliers["WeatherMakerFullScreenCloudsScript"] = 1.0f;
                WeatherMakerLightManagerScript.Instance.DirectionalLightShadowIntensityMultipliers["WeatherMakerFullScreenCloudsScript"] = 1.0f;
            }
        }
