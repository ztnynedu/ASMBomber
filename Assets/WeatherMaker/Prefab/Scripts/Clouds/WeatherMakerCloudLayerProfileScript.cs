...
namespace DigitalRuby.WeatherMaker
{
    ...
    public class WeatherMakerCloudLayerProfileScript : ScriptableObject
    {
        ...
        */
        ...
        [Tooltip("(DEACTIVATED TEMPORARILY) Cloud pixels with alpha greater than this will cast a shadow. Set to 1 to disable cloud shadows.")]
        [Range(0.0f, 1.0f)]
        public float CloudShadowThreshold = 0.1f;

        [Tooltip("(DEACTIVATED TEMPORARILY) Cloud shadow power. 0 is full power, higher values reduce shadow power.")]
        [Range(0.0001f, 2.0f)]
