...
namespace DigitalRuby.WeatherMaker
{
    ...
    public class WeatherMakerFogManagerScript : MonoBehaviour, IFogManager
    {
        ...
        /// <summary>
        /// Shared instance of precipitation renderer script
        /// </summary>
        public static WeatherMakerCloudManagerScript Instance
        {
            get
            {
                if (instance == null)
                {
                    foreach (WeatherMakerCloudManagerScript script in GameObject.FindObjectsOfType<WeatherMakerCloudManagerScript>())
                    {
                        if (script.enabled)
                        {
                            instance = script;
