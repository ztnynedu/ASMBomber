...
#pragma warning restore 0414
        ...
        private void UpdateAmbientColors(float l)
        {
            ...
            Shader.SetGlobalColor("_NightTexTintColor", NightSkyTintColor);
            Shader.SetGlobalColor("_NightTexAddColor", NightSkyAddColor);
            ...
            switch (AmbientColorMode)
            {
                case WeatherMakerDayNightAmbientColorMode.AmbientColor:
                    ...
                    Shader.SetGlobalColor("_WeatherMakerAmbientLightColor", ambientLight);
                    Shader.SetGlobalColor("_WeatherMakerAmbientLightColorSky", ambientLight);
                    Shader.SetGlobalColor("_WeatherMakerAmbientLightColorGround", ambientLight);
                    Shader.SetGlobalColor("_WeatherMakerAmbientLightColorEquator", ambientLight);
                    break;
                ...
                case WeatherMakerDayNightAmbientColorMode.SkyOnly:
                    ...
                    Shader.SetGlobalColor("_WeatherMakerAmbientLightColor", Color.black);
                    Shader.SetGlobalColor("_WeatherMakerAmbientLightColorSky", ambientLightSky);
                    Shader.SetGlobalColor("_WeatherMakerAmbientLightColorGround", Color.black);
                    Shader.SetGlobalColor("_WeatherMakerAmbientLightColorEquator", Color.black);
                    break;
                ...
                case WeatherMakerDayNightAmbientColorMode.SkyEquatorGround:
                    ...
                    Shader.SetGlobalColor("_WeatherMakerAmbientLightColor", Color.black);
                    Shader.SetGlobalColor("_WeatherMakerAmbientLightColorSky", ambientLightSky);
                    Shader.SetGlobalColor("_WeatherMakerAmbientLightColorGround", ambientLightGround);
                    Shader.SetGlobalColor("_WeatherMakerAmbientLightColorEquator", ambientLightEquator);
                    break;
                ...
                case WeatherMakerDayNightAmbientColorMode.AllWithUnityMode:
                    ...
                    Shader.SetGlobalColor("_WeatherMakerAmbientLightColor", ambientLight);
                    Shader.SetGlobalColor("_WeatherMakerAmbientLightColorSky", ambientLightSky + ambientLight);
                    Shader.SetGlobalColor("_WeatherMakerAmbientLightColorGround", ambientLightGround + ambientLight);
                    Shader.SetGlobalColor("_WeatherMakerAmbientLightColorEquator", ambientLightEquator + ambientLight);
                    break;
                ...
                default:
                    ...
                    RenderSettings.ambientGroundColor = Color.black;
                    Shader.SetGlobalColor("_WeatherMakerAmbientLightColor", Color.black);
                    Shader.SetGlobalColor("_WeatherMakerAmbientLightColorSky", Color.black);
                    Shader.SetGlobalColor("_WeatherMakerAmbientLightColorGround", Color.black);
                    Shader.SetGlobalColor("_WeatherMakerAmbientLightColorEquator", Color.black);
                    break;
            }
    ...
    public enum WeatherMakerDayNightAmbientColorMode
    {
        ...
        /// <summary>
        /// Only call DynamicGI.UpdateEnvironment periodically, using DynamicGIUpdateThresholdSeconds constant. No ambient colors. No Unity ambient light.
        /// </summary>
