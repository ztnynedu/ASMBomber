        ...
        private void UpdateLight(LightningLightParameters lp, IEnumerable<Light> lights, float delay, float peakStart, float peakEnd, float lifeTime)
        {
            ...
            if (realElapsedTime >= peakStart)
            {
                if (realElapsedTime <= peakEnd)
                {
                    ...
                    {
                        l.intensity = lp.LightIntensity * lp.LightIntensityMultiplier;
                    }
                }
                else
                {
                    ...
                    foreach (Light l in lights)
                    {
                        l.intensity = Mathf.Lerp(lp.LightIntensity * lp.LightIntensityMultiplier, 0.0f, lerp);
                    }
                }
            }
            else
            {
                ...
                foreach (Light l in lights)
                {
                    l.intensity = Mathf.Lerp(0.0f, lp.LightIntensity * lp.LightIntensityMultiplier, lerp);
                }
            }
        }
