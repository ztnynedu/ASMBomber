...
namespace DigitalRuby.WeatherMaker
{
    public class WeatherMakerFallingParticleScript : MonoBehaviour
    {
        ...
        private void UpdateExternalModifiers()
        {
            ...
            {
                CollisionEnabled = WeatherMakerScript.Instance.EnablePrecipitationCollision;
        ...
        {
            if (Application.isPlaying && !WeatherMakerScript.ShouldIgnoreCamera(this, camera) && WeatherMakerScript.CameraStack < 2)
            {
