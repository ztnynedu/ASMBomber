    ...
    public class WeatherMakerOverlayProfileScript : WeatherMakerBaseScriptableObjectScript
    {
        ...
        public void UpdateMaterial(Material overlayMaterial)
        {
            ...
            if (OverlayNoiseTexture != null && OverlayNoiseMultiplier > 0.0f)
            {
                ...
                overlayMaterial.SetInt("_OverlayNoiseEnabled", 1);
            }
            else
            {
                overlayMaterial.SetInt("_OverlayNoiseEnabled", 0);
            }
            if (OverlayMinHeight > 0.0f)
            {
                ...
                {
                    overlayMaterial.SetInt("_OverlayMinHeightNoiseEnabled", 1);
                ...
                {
                    overlayMaterial.SetInt("_OverlayMinHeightNoiseEnabled", 0);
                }
            }
            else
            {
                overlayMaterial.SetInt("_OverlayMinHeightNoiseEnabled", 0);
                overlayMaterial.SetFloat("_OverlayMinHeight", 0.0f);
            }
