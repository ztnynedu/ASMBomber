    ...
    SubShader
	{
		...
		Pass
		{
            ...
            v2f vert (appdata_t v)
            {
				...
				o.offsets = float2(_WeatherMakerShadowMapTexture_TexelSize.x * 0.333333, _WeatherMakerShadowMapTexture_TexelSize.y * 0.333333);
				...
				o.offsets = float4
				(
					_WeatherMakerShadowMapTexture_TexelSize.x * 0.4,
					_WeatherMakerShadowMapTexture_TexelSize.x * 1.2,
					_WeatherMakerShadowMapTexture_TexelSize.y * 0.4,
					_WeatherMakerShadowMapTexture_TexelSize.y * 1.2
				);
