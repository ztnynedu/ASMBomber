...
#define TESSELATION_DOMAIN_PROGRAM_INTERPOLATE_IMPLEMENTATION TESSELATION_DOMAIN_PROGRAM_INTERPOLATE(vertex) TESSELATION_DOMAIN_PROGRAM_INTERPOLATE(normal) TESSELATION_DOMAIN_PROGRAM_INTERPOLATE(uv) data.uv.w = factors.inside;
#endif
