...
Shader "WeatherMaker/WeatherMakerPrecipitationShader"
{
    ...
    SubShader
	{
        Tags { "Queue" = "Transparent-1" "RenderType" = "Transparent" "IgnoreProjector" = "True" "LightMode" = "Always" }
		LOD 100
        ...
        Pass
		{
            ...
            v2f vert(appdata_t v)
            {
				...
				o.color.rgb = CalculateLightColorWorldSpace(p).rgb;
			...
			{       
				...
				//v.color.a *= ClipWorldPosNullZonesFade(v.worldPos, v.rayDir, sceneZ, partZ, _InvFade);
				...
				color.rgb = CalculateLightColorWorldSpace(p).rgb;
