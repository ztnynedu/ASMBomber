...
Shader "WeatherMaker/WeatherMakerSkySphereShader"
{
	...
	SubShader
	{
		Tags { "Queue" = "Background" "RenderType" = "Background" "IgnoreProjector" = "True" "PerformanceChecks" = "False" "PreviewType" = "Skybox" "LightMode" = "Always" }
		...
		fixed4 fragBase(v2fSky i)
		{
			...
			{
				skyColor = CalculateSkyColorPreetham(i.ray, _WeatherMakerSunDirectionUp);
				skyColor.rgb *= _WeatherMakerSkyTintColor;
				nightColor = GetNightColor(i.ray, i.uv, skyColor.a);
